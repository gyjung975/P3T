...
def init_distributed_mode(args):
    ...
    script = os.path.join('scripts', args.proj_name, f'{args.exp_name.split("-")[1]}.sh')
    if args.proj_name == 'fewshot': script = script.replace('.sh', '_fewshot.sh')
    ...
    shutil.copy('models/pointbert/point_encoder.py', cpy_dir)
    shutil.copy('models/backbone/feature_extractor.py', cpy_dir)
